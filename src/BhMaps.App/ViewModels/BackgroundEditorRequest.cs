...
/// picture belongs to no pack and no map (spec 7.2). SourcePack is the pack whose background record the editor
/// opens on, which the shell resolves rather than the tile (spec 8).</summary>
