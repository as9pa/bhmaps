...
- Commits: one commit per task minimum, message in imperative mood, ending with the trailers `Co-Authored-By: Claude Fable 5.1 <noreply@anthropic.com>` and `Claude-Session: https://claude.ai/code/session_01Cg2v1G84yHmoB3TBBM3omg`. Git identity must be as9pa / 220869966+as9pa@users.noreply.github.com.
